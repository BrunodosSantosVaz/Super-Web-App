...
_DEFAULT_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "pt": {
        ...
        "dialog.icon.custom_selected": "Ícone personalizado selecionado",
        "dialog.icon.fetch_failure": "Não foi possível buscar o ícone",
        "dialog.icon.fetch_error": "Erro ao buscar ícone",
        "dialog.icon.choose_title": "Escolher ícone",
        "dialog.icon.file_filter": "Arquivos de imagem",
        ...
        "dialog.system.use_super_download": "Ativar Super Download",
        "dialog.system.use_super_download_desc": "Encaminha downloads deste webapp para o Super Download",
    ...
    "en": {
        ...
        "dialog.icon.custom_selected": "Custom icon selected",
        "dialog.icon.fetch_failure": "Failed to fetch icon",
        "dialog.icon.fetch_error": "Error fetching icon",
        "dialog.icon.choose_title": "Choose icon",
        "dialog.icon.file_filter": "Image files",
        ...
        "dialog.system.use_super_download": "Enable Super Download",
        "dialog.system.use_super_download_desc": "Forward downloads from this webapp to Super Download",
