...
_DEFAULT_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "pt": {
        ...
        "dialog.system.run_background": "Executar em segundo plano",
        "dialog.system.run_background_desc": "Mantém o webapp ativo mesmo com a janela fechada",
    ...
    "en": {
        ...
        "dialog.system.run_background": "Run in background",
        "dialog.system.run_background_desc": "Keep running when the window is closed",
